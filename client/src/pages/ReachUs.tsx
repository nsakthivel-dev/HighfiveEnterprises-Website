        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-12">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-5">
                  {contactInfo.map((info, index) => (
                    <motion.div
                      ...
                      className="p-5 rounded-2xl bg-secondary/30 border border-border/50 flex items-start gap-4 group hover:bg-card transition-colors"
                    >
                      ...
                      <div>
                        <p className="text-[10px] text-muted-foreground uppercase tracking-widest mb-1 font-semibold">{info.label}</p>
                        {info.href ? (
                          <a href={info.href} className="text-base font-medium hover:text-primary transition-colors">
                            {info.value}
                          </a>
                        ) : (
                ...
                <div className="flex flex-wrap gap-4">
                  {socialLinks.map((link, index) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground transition-all shadow-sm"
            ...
            <div className="lg:col-span-7">
              <div className="p-6 md:p-10 rounded-[2.5rem] bg-card border border-border shadow-2xl shadow-primary/5 relative overflow-hidden">
